## This script implements Exporatory Data Analysis Course Project1 plot1, a histogram 
## of Global Active Poweer.
...
hist(household.power.2days$Global_active_power, col = "red",main = "Global Active Power",xlab = "Global Active Power (kilowatts)")
dev.off()
